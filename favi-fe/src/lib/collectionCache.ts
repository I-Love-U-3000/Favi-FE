...
export function readCollectionReaction(id: string): ReactionCache | null {
...
export function writeCollectionReaction(id: string, data: Omit<ReactionCache, "updatedAt"> & { updatedAt?: number }) {
